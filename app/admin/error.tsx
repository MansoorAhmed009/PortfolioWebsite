  ...
  return (
    <section className="mx-auto w-full max-w-3xl px-4 pb-16 pt-20">
      <div className="rounded-2xl border border-rose-300/35 bg-rose-500/10 p-8">
        <h1 className="text-2xl font-semibold text-white">Admin dashboard failed to load</h1>
        <p className="mt-3 text-sm text-slate-200">Retry and confirm your admin session is still valid.</p>
        <button
          type="button"
          onClick={() => reset()}
